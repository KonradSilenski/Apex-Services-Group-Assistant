...
import PrivateRoute from '../components/AuthRedirect'
...
const JobView = Loadable(lazy(() => import('../views/dashboards/Job')) )
...
const Router = [
  {
    ...
    children: [
      ...
      { path: '/job', exact: true, element: <JobView />},
      { path: '/kpi', exact: true, element: <Typography /> },
